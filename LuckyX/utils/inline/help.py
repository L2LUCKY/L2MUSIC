...
def first_page(_):
	controll_button = [InlineKeyboardButton(text="◁", callback_data=f"Rani"), InlineKeyboardButton(text="HOME", callback_data=f"settingsback_helper"), InlineKeyboardButton(text="▷", callback_data=f"rajaXrani")]
